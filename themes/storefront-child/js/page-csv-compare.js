...
var oInput, csvDataOb, jsonOutput;
//CSV file input
var reader = new FileReader()
reader.onload = function (e) {
    var oInput = jQuery('#csv').val();
...
var csvParser = (function () {
    function quote(s) {
        return '"' + s.replace(/\\/g, '\\\\').replace(/"/g, '\\"').replace(/\x08/g, '\\b').replace(/\t/g,
                ...
                /[\x00-\x07\x0B\x0E-\x1F\x80-\uFFFF]/g, escape) +
            '"';
    }
    var result = {
        parse: function (input, startRule) {
            ...
            function escape(ch) {
                ...
                return '\\' + escapeChar + padLeft(charCode.toString(16).toUpperCase(), '0',
                    length);
            }
            ...
            if (result === null || pos !== input.length) {
                ...
                throw new this.SyntaxError(cleanupExpected(rightmostFailuresExpected), found,
                    offset, errorPosition.line, errorPosition.column);
            }
            return result;
        },
        toSource: function () {
